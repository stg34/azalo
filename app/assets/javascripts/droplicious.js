...
dropliciousMenu = Class.create({
	...
	initialize: function(){
		...
		$$("a.drops").invoke('observe', 'mouseout', this.linkMouseOut.bind(this));
                ...
                $$("span.drops").invoke('observe', 'mousemove', this.linkMouseOver.bind(this));
		$$("span.drops").invoke('observe', 'mouseout', this.linkMouseOut.bind(this));
	...
	showUpEffect: function(e, effectDuration){
		if(!e.visible() && window.show_page_menu != false){
...
/*document.observe('dom:loaded', function() {
	dropliciousMenu = new dropliciousMenu();
})*/