...
TooltipManager = {
  options: {cssClassName: 'tooltip', delayOver: 200, delayOut: 1000, shiftX: 10, shiftY: 10,
            className: 'alphacube', width: 300, height: null,
  ...
  addAjax: function(element, ajaxInfo, shiftX, shiftY) {
  ...
  _showTooltip: function(element) {
    ...
    shiftX = element.shiftX || TooltipManager.options.shiftX;
    shiftY = element.shiftY || TooltipManager.options.shiftY;
    ...
    var twidth = parseInt(this.tooltipWindow.getSize().width) + 14;
    var dw = width - position[0] - twidth - shiftX;
    ...
    this.tooltipWindow.setLocation(position[1] + dimension.height + shiftY, position[0] + shiftX + dw);
